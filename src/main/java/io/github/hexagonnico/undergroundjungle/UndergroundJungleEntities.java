...
public class UndergroundJungleEntities {
    ...
    public static final RegistryObject<EntityType<JungleSkeleton>> JUNGLE_SKELETON = register("jungle_skeleton", EntityType.Builder.of(JungleSkeleton::new, MobCategory.MONSTER).sized(0.6f, 1.99f).clientTrackingRange(8));
